...
class baggage6(imdb):
    ...
    def __init__(self, image_set, year, devkit_path=None):
        ...
        imdb.__init__(self, 'baggage6' + '_' + image_set)
        self._year = year
        ...
        self._classes = ('__background__', # always index 0
                         'camera', 'laptop', 'gun',
                         'gun_component', 'knife', 'ceramic_knife')
    ...
    def _get_default_path(self):
        ...
        return os.path.join(cfg.DATA_DIR, 'baggage6')
    ...
    def gt_roidb(self):
        ...
        gt_roidb = [self._load_baggage6_annotation(index)
    ...
    def _load_baggage6_annotation(self, index):
        """
