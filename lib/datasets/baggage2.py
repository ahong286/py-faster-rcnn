...
class baggage2(imdb):
    ...
    def __init__(self, image_set, year, devkit_path=None):
        ...
        imdb.__init__(self, 'baggage2' + '_' + image_set)
        self._year = year
    ...
    def _get_default_path(self):
        ...
        return os.path.join(cfg.DATA_DIR, 'baggage2')
    ...
    def gt_roidb(self):
        ...
        gt_roidb = [self._load_baggage2_annotation(index)
    ...
    def _load_baggage2_annotation(self, index):
        """
    ...
    def competition_mode(self, on):
        if on:
            ...
            self.config['cleanup'] = False # Should be true
