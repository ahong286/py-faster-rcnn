...
class dleb17(imdb):
    ...
    def __init__(self, image_set, year, devkit_path=None):
        ...
        imdb.__init__(self, 'dleb17' + '_' + image_set)
        self._year = year
    ...
    def _get_default_path(self):
        ...
        return os.path.join(cfg.DATA_DIR, 'dleb17')
    ...
    def gt_roidb(self):
        ...
        gt_roidb = [self._load_dleb17_annotation(index)
    ...
    def _load_dleb17_annotation(self, index):
        """
        ...
        for ix, obj in enumerate(objs):
            # we added this line to ignore classes that we are not interested.
