...
def vis_detections(
    ...
    # for each class detections.
    # For instance for each detected gun,
    # we'll have 1 big bounding box.
    bbox = np.amax(dets[inds, :4], axis=0)
    score = np.mean(dets[inds, -1])
